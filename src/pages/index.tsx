/*
3 Formas de consumir uma API no next
(1 forma funciona em qualquer projeto react as outras duas só funionam no next)

1- Forma SPA - Single Page Application
2- Forma SSR - Server Side Render
3- Forma SSG - Static Site Generation (só funciona em produção)
*/
